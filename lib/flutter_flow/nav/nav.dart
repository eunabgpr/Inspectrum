...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Gazer',
          path: '/gazer',
          builder: (context, params) => const GazerWidget(),
        ),
        FFRoute(
          name: 'AboutUs',
          path: '/aboutUs',
        ...
        FFRoute(
          name: 'AboutTheTest',
          path: '/aboutTheTest',
          builder: (context, params) => const AboutTheTestWidget(),
        ),
        FFRoute(
          name: 'AQ1',
          path: '/aq1',
          builder: (context, params) => const Aq1Widget(),
        ),
        FFRoute(
          name: 'result',
          path: '/result',
        ...
        FFRoute(
          name: 'connectPage',
          path: '/connectPage',
          builder: (context, params) => const ConnectPageWidget(),
        )
